...
<header class="dash-toolbar">
    ...
    <div class="main-label">
       <button id="add_new_btn">
        <i><img src="{{asset('icons/refresh.svg')}}" style="width:20px; height:20px;"/></i> Update Currency
       </button>
...
@section('main')
<!--
                <p class="p1">Currency Archive</p>

                <div class="clients_table">
                    <table class="pro-table" id="deptbl" style="padding-top:3%;">
                        <thead>

                            <th width="165px">The Value</th>
                           <th width="165px">Update Date</th>

                        </thead>
                        <tbody>
                       @foreach ($currencies as $d)
					   <tr>
					   <td>{{$d->us_value}} $ = {{$d->sp_value}} s.p</td>
                ...
                !-->
                @include('modal.currency.currencyModal')
<script>
    ...
    $(document).ready(function(){
        ...
        var modal1 = document.getElementById("currencyModal");
