...
@section('main')
<a   class="button" href="{{route('project.trashed')}}"style='color:#161B25;'> <i> <img class="iconButton"   src="{{ asset('icons/archive.svg') }}"> </i>Archive </a>
                ...
                <div class="clients_table">
                    <table class="pro-table" id="projecttbl" style="padding-top:3%;">
						...
						<td>{{$p['price']}} </td>
						<td> <a href='project/{{$p["id"]}}/edit' style='color:#377CDB;'><i> <img class="delete_img" src="{{ asset('icons/edit.svg') }}"> </i></a>
							<a href='project/{{$p["id"]}}/destroy' style='color:#DC3545;'><i> <img class="delete_img" src="{{ asset('icons/delete.svg') }}"> </i></a></td>
						</tr>
						@endforeach
                        </tbody>
                    </table>
