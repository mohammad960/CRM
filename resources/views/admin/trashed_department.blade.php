...
@section('main')
                <p class="p1">Departments (<span id="usersnum">{{count($department)}}</span>)</p>
                ...
                <div class="clients_table">
                    <table class="pro-table" id="deptbl" style="padding-top:3%;">
					   ...
					   <tr>
					   <td>{{$d->name}}</td>
					   <td><a href='/admin/department/{{$d->id}}/restore' style='color:#377CDB;'><i> <img class="delete_img" src="{{ asset('icons/edit.svg') }}"> </i></a>
					   </tr>
					   @endforeach
