...
@section('main')
<p class="p1">Positions (<span id="usersnum">{{count($position)}}</span>)</p>
...
<div >
    <table class="pro-table" id="deptbl" style="padding-top:3%;">
       ...
       <td>{{$d->part_project}}</td>
        <td>{{$d->name}}</td>
       <td><a href='/admin/position/{{$d->id}}/restore' style='color:#377CDB;'><i> <img class="delete_img" src="{{ asset('icons/edit.svg') }}"> </i></a></td>
       </tr>
       @endforeach
