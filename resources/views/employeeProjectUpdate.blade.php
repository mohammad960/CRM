...
$( "#modal_save" ).click(function() {
		...
		var position=document.getElementById("position_all").innerHTML;
...
        document.getElementById("time_until").innerHTML=newdate+" ("+parseInt(sum_hours/8)+" work day  and "+sum_hours%8+" hours)";
  ...
  , "<span class='tl-text'>"+position+"</span>","<span class='empprog_enddate'>0</span><center><div class='progress empprogress' style='height: 6.34px; border-radius: 5px;'><div class='progress-bar bg-warning' role='progressbar' style='width: 0% ;border-radius: 5px;' aria-valuenow='50' aria-valuemin='0' aria-valuemax='100'></div></div> </center>",
  "<span class='tl-text'>0/"+exp_hours+"</span>",
  "<span class='tl-text'>0/"+back_hours+"</span>",
    "<span class='tl-text'>"+0+"</span>",
